...
public class DefaultTypeConverterTest extends TestCase {
    ...
    public void testPrimitives() {
        ...
        assertEquals(new Integer(2), DefaultTypeConverter.INSTANCE.convert(Integer.class, new Long(2)));
    }
    ...
    public void testPrimativeAccessors() {
        ...
        assertEquals(5, DefaultTypeConverter.INSTANCE.convert(Integer.class, 5).intValue());
        assertEquals(6, DefaultTypeConverter.INSTANCE.convert(Long.class, (long) 6).longValue());
        assertEquals((float) 7.1, DefaultTypeConverter.INSTANCE.convert(Float.class, (float) 7.1).floatValue());
        assertEquals(123.123, DefaultTypeConverter.INSTANCE.convert(Double.class, 123.123).doubleValue());
    }
    ...
    public void testMultiValue() {
        ...
        assertEquals(13, DefaultTypeConverter.INSTANCE.size(list));
